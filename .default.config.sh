...
# space separated list of devices to backup the MBR partion table from
MBR_TABLES="/dev/disk/by-id/ata-FOO /dev/disk/by-id/scsi-FOO /dev/disk/by-id/ata-FOO /dev/disk/by-id/scsi-BAR"

# space separated list of devices to backup the GPT partion table from
GPT_TABLES="/dev/disk/by-id/ata-FOO /dev/disk/by-id/scsi-BAZ"
